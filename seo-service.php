...
<style>
.fonts-loaded .text-gradient-gold{background:linear-gradient(135deg,#0891B2,#22D3EE,#22D3EE);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
...
<header class="relative bg-gradient-to-br from-[#064E5C] via-[#0891B2] to-[#22D3EE] overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 text-center">
        <nav class="flex justify-center items-center gap-2 text-white/70 text-xs mb-8" aria-label="Breadcrumb">
            ...
            <span class="text-[#10B981]"><?= htmlspecialchars($svc['name']) ?></span>
        </nav>
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
    ...
    <section class="mb-20">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                <span class="text-[#22D3EE] font-semibold text-xs uppercase tracking-[0.2em] block mb-4">Hizmet Detayı</span>
                ...
                <div class="grid sm:grid-cols-2 gap-3">
                    ...
                    <div class="flex items-center gap-3">
                        <?= svgIcon('verified', 'text-[#22D3EE] text-lg') ?>
    ...
    <section class="mb-20">
        ...
        <div class="max-w-2xl mx-auto bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="bg-gradient-to-r from-[#064E5C] to-[#0891B2] px-8 py-4 flex justify-between items-center">
                <span class="text-white font-semibold text-sm">Hizmet</span>
                <span class="text-[#10B981] font-semibold text-sm">Fiyat</span>
            </div>
            ...
            <div class="flex justify-between items-center px-8 py-4 <?= $isLast ? '' : 'border-b border-gray-50' ?> hover:bg-gray-50/50 transition-colors">
                ...
                <div class="text-right ml-4 flex-shrink-0">
                    <span class="text-[#0891B2] font-bold"><?= htmlspecialchars($price) ?></span>
                    <?php if (!empty($item['unit'])): ?>
                    <span class="block text-[#22D3EE] text-xs opacity-70"><?= htmlspecialchars($item['unit']) ?></span>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; ?>
    ...
    <section class="mb-20">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            $reasons = [
                ...
                ['schedule', 'Teslimat Süreci', 'Standart yıkama ortalama 6-7 iş günü içinde tamamlanır. Teslimat öncesinde sizinle iletişime geçerek uygun zamanı belirliyoruz.'],
    ...
    <section class="mb-20">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <a href="/<?= htmlspecialchars($os['slug']) ?>" class="bg-white p-5 rounded-xl border border-gray-100 text-center hover:border-[#22D3EE]/30 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                <div class="w-12 h-12 rounded-xl bg-[#22D3EE]/10 flex items-center justify-center mx-auto mb-3">
                    <?= svgIcon($os['icon'], 'text-[#22D3EE]', '1.25rem') ?>
                </div>
...
<section class="bg-gradient-to-r from-[#064E5C] via-[#0891B2] to-[#22D3EE] py-20 text-center px-4">
    <h2 class="font-headline text-3xl sm:text-4xl text-white mb-6"><?= htmlspecialchars($svc['name']) ?> İçin <span class="text-[#10B981] italic">Hemen Arayın</span></h2>
...
<!-- Call Button -->
<a href="tel:<?= htmlspecialchars($phoneRaw) ?>" class="fixed bottom-20 right-6 md:bottom-22 md:right-8 bg-gradient-to-br from-[#0891B2] to-[#22D3EE] text-white w-12 h-12 rounded-full shadow-[0_0_24px_rgba(10,77,104,0.4)] hover:scale-110 hover:shadow-[0_0_32px_rgba(10,77,104,0.5)] transition-all duration-500 ease-out z-[100] flex items-center justify-center cursor-pointer group" id="callButton">
    <?= svgIcon('call', 'text-on-primary text-2xl') ?>
