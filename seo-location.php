...
<style>
.fonts-loaded
.text-gradient-gold{background:linear-gradient(135deg,#0891B2,#22D3EE,#22D3EE);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
@keyframes shimmer{0%{background-position:-200% 0}100%{background-position:200% 0}}
.btn-shimmer{background:linear-gradient(110deg,#059669 0%,#10B981 25%,#10B981 50%,#10B981 75%,#059669 100%);background-size:200% 100%;animation:shimmer 4s linear infinite}
.nav-link{position:relative}
.nav-link::after{content:'';position:absolute;bottom:-4px;left:50%;width:0;height:2px;background:#10B981;transition:all .3s ease;transform:translateX(-50%)}
...
<style>
    ...
    .nav-link::after { content: ''; position: absolute; bottom: -4px; left: 50%; width: 0; height: 2px; background: #10B981; transition: all 0.3s ease; transform: translateX(-50%); }
    ...
    .nav-hero .nav-link:hover { color: #10B981 !important; }
    .nav-hero .nav-link.active { color: #10B981 !important; }
    .nav-hero .text-gradient-gold { background: linear-gradient(135deg, #FFFFFF, #10B981); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
    .nav-hero .logo-circle { background: linear-gradient(135deg, #10B981, #059669) !important; }
    .nav-hero #mobileMenuBtn { color: white !important; }
    .nav-scrolled .nav-link { color: rgba(255,255,255,0.85) !important; font-weight: 500; }
    .nav-scrolled .nav-link:hover { color: #10B981 !important; }
    .nav-scrolled .nav-link.active { color: #10B981 !important; }
    .nav-scrolled .text-gradient-gold { background: linear-gradient(135deg, #FFFFFF, #10B981); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
    .nav-scrolled #mobileMenuBtn { color: white !important; }
    #mobileMenu .nav-link { color: white !important; }
    #mobileMenu .nav-link:hover { color: #10B981 !important; }
    #mobileMenu .nav-link.active { color: #10B981 !important; }
...
<div id="topBar" class="bg-[#064E5C] border-b border-white/10 py-2 text-xs z-[60] relative">
    <div class="flex justify-between items-center px-4 sm:px-6 lg:px-10 max-w-full">
        <div class="flex items-center gap-5 text-white/70">
            <a href="tel:05322402672" data-kv-href="phone_raw" data-kv-href-prefix="tel:" class="flex items-center gap-1.5 hover:text-[#10B981] transition-colors">
                <svg class="text-sm text-[#10B981]" style="width:1em;height:1em;vertical-align:middle;flex-shrink:0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
                <span data-kv="phone">0532 240 26 72</span>
            </a>
            <a href="tel:" data-kv-href="phone2_raw" data-kv-href-prefix="tel:" class="flex items-center gap-1.5 hover:text-[#10B981] transition-colors">
                <svg class="text-sm text-[#10B981]" style="width:1em;height:1em;vertical-align:middle;flex-shrink:0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
                <span data-kv="phone2"></span>
            </a>
        ...
        <div class="flex items-center justify-center gap-3 text-white/70 sm:w-[160px]" id="kvTopBarSocial">
            <a href="https://www.instagram.com/ankara_temizlik_servisi?utm_source=qr&igsh=MWxpZWw5MWhpeWlmbg%3D%3D" target="_blank" rel="noopener noreferrer" class="hover:text-[#10B981] transition-colors" title="Instagram"><svg class="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg></a>
            <a href="https://www.facebook.com/share/1Arw9fBdFD/" target="_blank" rel="noopener noreferrer" class="hover:text-[#10B981] transition-colors" title="Facebook"><svg class="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a>
            <a href="mailto:ankaratemizlikservisi1@gmail.com" class="hover:text-[#10B981] transition-colors" title="E-posta"><span class="material-symbols-outlined text-base" style="font-variation-settings:'FILL' 1">mail</span></a>
        </div>
    </div>
</div>
...
<nav id="mainNav" class="sticky w-full z-50 transition-all duration-500"  role="navigation" aria-label="Ana navigasyon">
    ...
    <!-- Mobile Menu -->
    <div id="mobileMenu" class="lg:hidden w-full px-6 space-y-4 bg-[#064E5C]/95 backdrop-blur-xl border-t border-white/10">
        <a class="nav-link block font-label text-sm uppercase tracking-[0.15em] text-white hover:text-[#10B981] py-2" href="/#hizmetlerimiz">Hizmetlerimiz</a>
        <a class="nav-link block font-label text-sm uppercase tracking-[0.15em] text-white hover:text-[#10B981] py-2" href="/#surecimiz">Sürecimiz</a>
        <a class="nav-link block font-label text-sm uppercase tracking-[0.15em] text-white hover:text-[#10B981] py-2" href="/#hakkimizda">Hakkımızda</a>
        <a class="nav-link block font-label text-sm uppercase tracking-[0.15em] text-white hover:text-[#10B981] py-2" href="/#galeri">Galeri</a>
        <a class="nav-link block font-label text-sm uppercase tracking-[0.15em] text-white hover:text-[#10B981] py-2" href="/#yorumlar">Yorumlar</a>
        <a class="nav-link block font-label text-sm uppercase tracking-[0.15em] text-white hover:text-[#10B981] py-2" href="/blog/">Blog</a>
        <a class="nav-link block font-label text-sm uppercase tracking-[0.15em] text-white hover:text-[#10B981] py-2" href="/#iletisim">İletişim</a>
...
<!-- Hero -->
<header class="relative bg-gradient-to-br from-[#064E5C] via-[#0891B2] to-[#22D3EE] overflow-hidden">
    <div class="absolute inset-0 opacity-10">
        <div class="absolute top-20 right-20 w-96 h-96 bg-[#10B981] rounded-full blur-[120px]"></div>
        <div class="absolute bottom-10 left-10 w-64 h-64 bg-[#22D3EE] rounded-full blur-[100px]"></div>
    </div>
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 text-center">
        ...
        <nav class="flex justify-center items-center gap-2 text-white/70 text-xs mb-8" aria-label="Breadcrumb">
            <a href="/" class="hover:text-[#10B981] transition-colors">Ana Sayfa</a>
            ...
            <span class="text-[#10B981]"><?= htmlspecialchars($loc['name']) ?> <?= htmlspecialchars($svc['name']) ?></span>
        </nav>
        <h1 class="font-headline text-4xl sm:text-5xl lg:text-6xl font-light text-white mb-6 tracking-wide">
            ...
            <span class="text-[#10B981] italic"><?= htmlspecialchars($svc['name']) ?> Hizmeti</span>
        </h1>
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
    ...
    <section class="mb-20">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                <span class="text-[#22D3EE] font-semibold text-xs uppercase tracking-[0.2em] block mb-4"><?= htmlspecialchars($loc['name']) ?> Hizmet Detayı</span>
                ...
                <div class="grid sm:grid-cols-2 gap-3">
                    ...
                    <div class="flex items-center gap-3">
                        <svg class="text-[#22D3EE] text-lg" style="width:1em;height:1em;vertical-align:middle;flex-shrink:0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>
            ...
            <div class="relative">
                <div class="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#22D3EE]/20 to-[#0891B2]/10">
                ...
                <div class="absolute -bottom-4 -left-4 bg-white p-5 rounded-2xl shadow-xl border border-gray-100">
                    <div class="flex items-center gap-3">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-[#10B981] to-[#059669] flex items-center justify-center">
    ...
    <!-- Bölgeye Özel Bilgi -->
    <section class="mb-20">
        <div class="bg-gradient-to-br from-[#064E5C] to-[#0891B2] rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden">
            <div class="absolute top-0 right-0 w-64 h-64 bg-[#10B981]/10 rounded-full blur-[80px]"></div>
            <div class="relative z-10">
                <span class="text-[#10B981] font-semibold text-xs uppercase tracking-[0.2em] block mb-4">Bölge Bilgisi</span>
    ...
    <section class="mb-20">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div class="w-12 h-12 rounded-xl bg-[#22D3EE]/10 flex items-center justify-center mb-4">
                    <?= svgIcon($r[0], 'text-[#22D3EE]', '1.25rem') ?>
                </div>
    ...
    <section class="mb-20">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="text-center p-6 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div class="w-16 h-16 rounded-full bg-gradient-to-br from-[#22D3EE] to-[#0891B2] flex items-center justify-center mx-auto mb-4">
                    <?= svgIcon($step[0], 'text-white', '1.5rem') ?>
                </div>
                <div class="text-[#10B981] font-bold text-sm mb-2"><?= $i + 1 ?>. Adım</div>
        ...
        <div class="max-w-3xl mx-auto space-y-4">
            ...
            <details class="group bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <summary class="flex items-center justify-between p-6 cursor-pointer hover:bg-gray-50 transition-colors">
                    ...
                    <svg class="text-[#22D3EE] group-open:rotate-180 transition-transform duration-300 flex-shrink-0" style="width:1em;height:1em;vertical-align:middle;flex-shrink:0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>
                </summary>
    ...
    <section class="mb-20">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <a href="/<?= htmlspecialchars($locSlug . '-' . $os['slug']) ?>" class="bg-white p-4 rounded-xl border border-[#10B981]/30 text-center hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                <?= svgIcon($os['icon'], 'text-[#10B981] mb-2 block', '1.5rem') ?>
                <span class="font-semibold text-gray-800 text-sm"><?= htmlspecialchars($loc['name']) ?></span>
                <span class="block text-[#10B981] text-xs mt-1"><?= htmlspecialchars($os['name']) ?></span>
            </a>
            <?php endforeach; ?>
            <?php foreach ($otherLocations as $ol): ?>
            <a href="/<?= htmlspecialchars($ol['slug'] . '-' . $svcSlug) ?>" class="bg-white p-4 rounded-xl border border-gray-100 text-center hover:border-[#22D3EE]/30 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                <svg class="text-[#22D3EE] text-2xl mb-2 block" style="width:1em;height:1em;vertical-align:middle;flex-shrink:0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
    ...
    <section class="mb-16">
        ...
        <div class="grid sm:grid-cols-3 gap-6">
            ...
            <a href="/blog/<?= htmlspecialchars($rb['slug']) ?>" class="bg-white p-6 rounded-2xl border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 block group">
                <h3 class="font-headline text-lg text-gray-900 mb-3 group-hover:text-[#22D3EE] transition-colors line-clamp-2"><?= htmlspecialchars($rb['title']) ?></h3>
                <p class="text-gray-500 text-sm leading-relaxed line-clamp-3 mb-4"><?= htmlspecialchars($rb['summary'] ?? '') ?></p>
                <span class="text-[#22D3EE] text-sm font-semibold flex items-center gap-1">Devamını Oku <svg class="text-sm" style="width:1em;height:1em;vertical-align:middle;flex-shrink:0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg></span>
            </a>
            <?php endforeach; ?>
        </div>
    </section>
...
<!-- CTA -->
<section class="bg-gradient-to-r from-[#064E5C] via-[#0891B2] to-[#22D3EE] py-20 text-center px-4">
    <h2 class="font-headline text-3xl sm:text-4xl text-white mb-6"><?= htmlspecialchars($loc['name']) ?>'da <?= htmlspecialchars($svc['name']) ?> İçin <span class="text-[#10B981] italic">Hemen Arayın</span></h2>
    ...
    <div class="flex flex-wrap justify-center gap-4">
        <a href="/#iletisim" class="bg-[#10B981] text-white px-10 py-4 rounded-full font-bold hover:bg-[#059669] hover:scale-105 transition-all shadow-xl">Ücretsiz Keşif Al</a>
        <?php if ($phoneRaw): ?>
...
<!-- Footer -->
<footer class="bg-[#064E5C] pt-16 sm:pt-24 pb-12 px-4 sm:px-6 lg:px-8 border-t border-white/10" role="contentinfo">
    <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
        <div>
            <div class="flex items-center gap-3 mb-6">
                <div class="w-9 h-9 rounded-full bg-gradient-to-br from-[#10B981] to-[#059669] flex items-center justify-center">
        ...
        <div>
            <h3 class="text-xs font-label uppercase tracking-widest text-[#10B981] mb-6">Hızlı Menü</h3>
            <ul class="space-y-4">
                <li><a class="text-white/70 hover:text-[#10B981] transition-colors text-sm" href="/#hizmetlerimiz">Hizmetlerimiz</a></li>
                <li><a class="text-white/70 hover:text-[#10B981] transition-colors text-sm" href="/#surecimiz">Sürecimiz</a></li>
                <li><a class="text-white/70 hover:text-[#10B981] transition-colors text-sm" href="/#hakkimizda">Hakkımızda</a></li>
                <li><a class="text-white/70 hover:text-[#10B981] transition-colors text-sm" href="/galeri">Galeri</a></li>
                <li><a class="text-white/70 hover:text-[#10B981] transition-colors text-sm" href="/blog/">Blog</a></li>
                <li><a class="text-white/70 hover:text-[#10B981] transition-colors text-sm" href="/#iletisim">İletişim</a></li>
            </ul>
        </div>
        <div>
            <h3 class="text-xs font-label uppercase tracking-widest text-[#10B981] mb-6">İletişim</h3>
            <ul class="space-y-4">
                <li><span class="text-white/70 text-sm" data-kv="phone">0532 240 26 72</span></li>
                <li><span class="text-white/70 text-sm" data-kv="phone2"></span></li>
                <li><span class="text-white/70 text-sm" data-kv="email">ankaratemizlikservisi1@gmail.com</span></li>
                <li><span class="text-white/70 text-sm">Yeni Çimşit Mah. Çimşit Kümeevleri No: 279 A Sincan/Ankara</span></li>
            </ul>
        </div>
        <div>
            <h3 class="text-xs font-label uppercase tracking-widest text-[#10B981] mb-6">Bülten</h3>
            <p class="text-sm text-white/70 mb-4">Bakım ipuçları ve kampanyalar için abone olun.</p>
            <div class="relative">
                <input class="w-full bg-white/10 border border-white/20 rounded-xl py-3 px-5 text-sm text-white placeholder-white/30 focus:ring-1 focus:ring-[#10B981] transition-all" placeholder="E-posta adresiniz" type="email"/>
                <button class="absolute right-2 top-1.5 bg-gradient-to-r from-[#059669] to-[#10B981] text-white p-1.5 rounded-lg"><svg class="text-sm" style="width:1em;height:1em;vertical-align:middle;flex-shrink:0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg></button>
            </div>
            <div class="mt-8">
    ...
    <div class="max-w-7xl mx-auto mt-12 pt-8 border-t border-white/10">
        <h3 class="text-xs font-label uppercase tracking-widest text-[#10B981] mb-4">Hizmet Bölgelerimiz</h3>
        <div class="flex flex-wrap gap-x-4 gap-y-1 text-xs text-white/60">
            {{__SEO_LINKS_DEFERRED__}}
        </div>
    </div>
    <div class="max-w-7xl mx-auto mt-8 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-white/25 uppercase tracking-widest">
        ...
        <div class="flex gap-6">
            <a class="hover:text-[#10B981] transition-colors" href="/gizlilik-politikasi">Gizlilik Politikası</a>
            <a class="hover:text-[#10B981] transition-colors" href="/kvkk">KVKK Aydınlatma</a>
            <a class="hover:text-[#10B981] transition-colors" href="/kullanim-sartlari">Kullanım Şartları</a>
        </div>
    </div>
</footer>
...
<!-- Call Button -->
<a href="tel:<?= htmlspecialchars($phoneRaw) ?>" data-kv-href="phone_raw" data-kv-href-prefix="tel:" class="fixed bottom-20 right-6 md:bottom-22 md:right-8 bg-gradient-to-br from-[#0891B2] to-[#22D3EE] text-white w-12 h-12 rounded-full shadow-[0_0_24px_rgba(10,77,104,0.4)] hover:scale-110 hover:shadow-[0_0_32px_rgba(10,77,104,0.5)] transition-all duration-500 ease-out z-[100] flex items-center justify-center cursor-pointer group" id="callButton">
    <svg class="text-on-primary text-2xl" style="width:1em;height:1em;vertical-align:middle;flex-shrink:0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
    <div class="absolute right-14 bg-[#0891B2] text-white px-4 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap font-bold text-sm">Hemen Ara</div>
</a>
...
<!-- Scroll to Top -->
<button id="scrollTopBtn" class="fixed bottom-6 left-6 md:bottom-8 md:left-8 bg-[#0891B2] text-white w-12 h-12 rounded-full shadow-lg shadow-[#0891B2]/20 hover:scale-105 hover:shadow-[#0891B2]/40 transition-all duration-500 ease-out z-[100] flex items-center justify-center" onclick="window.scrollTo({top:0,behavior:'smooth'})" aria-label="Yukarı çık">
