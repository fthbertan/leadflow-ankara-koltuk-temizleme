...
try {
    ...
    if ((int)$count === 0) {
        $defaults = [
            'business_name'      => 'Ankara Koltuk Temizleme',
            'phone'              => '0532 240 26 72',
            'phone_raw'          => '05322402672',
            'email'              => 'ankaratemizlikservisi1@gmail.com',
            'address'            => 'Yeni Çimşit Mah. Çimşit Kümeevleri No: 279 A Sincan/Ankara',
            'working_hours'      => 'Pzt-Cmt: 08:00 - 20:00',
            'working_hours_short'=> 'Pzt-Cmt: 08:00 - 20:00',
            'whatsapp_number'    => '905324669671',
            'phone2'             => '',
            'phone2_raw'         => '',
            'hero_subtitle'      => 'Premium Yerinde Koltuk Yıkama',
            'footer_description' => 'Ankara Koltuk Temizleme olarak, koltuklarınızı adresinizde, profesyonel ekip ve ekipmanlarla en hijyenik şekilde temizliyoruz.',
            'cta_title'          => 'Koltuklarınız Yepyeni Gibi',
            'cta_description'    => 'Profesyonel yerinde koltuk yıkama hizmetimizle aynı gün kuruyan, mis gibi koltuklara sahip olun.',
            'map_embed_url'      => 'https://maps.google.com/maps?q=Yeni%20%C3%87im%C5%9Fit%20Mah.%20%C3%87im%C5%9Fit%20K%C3%BCmeevleri%20No%3A%20279%20A%20Sincan%2FAnkara&output=embed&hl=tr',
            'map_link_url'       => 'https://www.google.com/maps/search/?api=1&query=Yeni%20%C3%87im%C5%9Fit%20Mah.%20%C3%87im%C5%9Fit%20K%C3%BCmeevleri%20No%3A%20279%20A%20Sincan%2FAnkara',
            'instagram'          => '',
            'facebook'           => '',
            'blog_author_name'   => 'Ankara Koltuk Temizleme Uzman Ekibi',
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-lg max-w-lg w-full p-8">
        <div class="text-center mb-6">
            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#3B5F8A] to-[#1E3A5F] flex items-center justify-center mx-auto mb-4">
        ...
        <div class="space-y-3">
            <a href="../" class="block w-full bg-gradient-to-r from-[#3B5F8A] to-[#1E3A5F] text-white text-center font-bold py-3 rounded-xl hover:opacity-90 transition">Siteye Git</a>
